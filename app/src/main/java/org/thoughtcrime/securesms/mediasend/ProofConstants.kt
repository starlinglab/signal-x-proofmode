...
object ProofConstants {
  ...
  const val IS_PROOF_NETWORK_AND_PHONE_ENABLED_GLOBAL = "IS_PROOF_NETWORK_AND_PHONE_ENABLED_GLOBAL"
  ...
  const val IS_PROOF_NETWORK_AND_PHONE_ENABLED_LOCAL = "IS_PROOF_NETWORK_AND_PHONE_ENABLED_LOCAL"
